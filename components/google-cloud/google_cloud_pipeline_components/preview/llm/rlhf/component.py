...
from google_cloud_pipeline_components._implementation.llm import llm_model_handler_graph
...
def rlhf_pipeline(
  ...
  llm_model_handler = llm_model_handler_graph.pipeline(
      output_adapter_path=rl_model.outputs['output_model_path'],
      large_model_reference=large_model_reference,
      model_display_name=model_display_name,
      deploy_model=deploy_model,
  ).set_display_name('Upload and Deploy LLM Model')
